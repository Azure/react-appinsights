...
You can also run custom queries to slice and dice this data. In the Azure portal, navigate to the Application Insights resource, select "Anylytics" from the top menu and run following query (or your own custom query as you like).
